        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Profile_ProfileId = table.Column<int>(type: "integer", nullable: true),
                    Profile_Name = table.Column<string>(type: "text", nullable: true),
                    Profile_Surname = table.Column<string>(type: "text", nullable: true),
                    Profile_PhoneNumber = table.Column<string>(type: "text", nullable: true),
                    Profile_City = table.Column<string>(type: "text", nullable: true),
                    Profile_Street = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_ProductPhotos_ImageId",
                        column: x => x.ImageId,
